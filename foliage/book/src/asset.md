...
before [`photosynthesize`](./app.md) -- or [`Grows::load_asset`](./forest.md) --
called on a `Forest`/`Sprig` from inside a running app -- both return a key immediately.
...
resolved via [`Moss::AssetLoaded`](./forest.md), then reads the bytes with
[`Forest::asset`](./forest.md).
...
boundary via [`Moss::AssetLoaded`](./forest.md)/[`Forest::asset`](./forest.md), covered
above.
