use foliage::{left, Area, Boxed, Foliage, Grove, Grow, Leaf, Location, Pollen, Root, Source, TextArea, top, Panel, Palette};
...
impl Root for Example {
    fn take_root(grove: &mut Grove) -> Self {
        ...
        let area = grove.plant(TextArea::new()
            .at(Location::new().xs(
