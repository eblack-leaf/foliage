...
fn setup(
    ...
    let transition = TransitionDescriptor::new(&mut cmd)
        ...
        .bind_scene::<TrackProgress>(vec![(
            ...
            TrackProgressArgs::new(Duration::from_secs(180), Color::GREEN_MEDIUM, Color::GREY_DARK),
        )])
        .build();
    // add-to-workflow
