...
/// Chapter 8: the authoring pattern that packages everything before it -- config in via
/// `root()`, reactive multi-entity structure out via `build()`. Placeholder shape only;
/// the real infographic for this concept lands later.
