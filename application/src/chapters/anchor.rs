...
/// Chapter 4: position relative to another entity's *live* box, not just your structural
/// parent -- decouples "where it's parented" from "where it visually sits." Placeholder
/// shape only; the real infographic for this concept lands later.
