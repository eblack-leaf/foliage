...
/// Chapter 6: chaining/staggering several animations together and reacting once they
/// all finish (`OnEnd`). Placeholder shape only; the real infographic for this concept
/// lands later.
